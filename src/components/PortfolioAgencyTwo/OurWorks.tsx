        ...
        <section className="case-studies-area lg-portfolio ptb-100">
          <div className="container">
            ...
            <div className="row">
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="work-card">
                  <Image src="/images/works/work9.jpg" alt="image" />
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="work-card">
                  <Image src="/images/works/work10.jpg" alt="image" />
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="work-card">
                  <Image src="/images/works/work11.jpg" alt="image" />
              ...
              <div className="col-lg-4 col-sm-6">
                <div className="work-card">
                  <Image src="/images/works/work12.jpg" alt="image" />
